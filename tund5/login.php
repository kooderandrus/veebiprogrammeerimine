...
<body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		...
		<input name="loginEmail" type="email" value="<?php echo $loginEmail; ?>"><span style="color:red"><?php echo " " .$loginEmailError; ?></span>
		<br><br>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		...
		<input type="radio" name="gender" value="2" <?php if ($gender == '2') {echo 'checked';} ?>><label>Naine</label><span style="color:red"><?php echo " " .$signupGenderError; ?></span>
		<br><br>
		
		<label>Kasutajanimi (E-post)</label>
		<input name="signupEmail" type="email" value="<?php echo $signupEmail; ?>"><span style="color:red"><?php echo " " .$signupEmailError; ?></span>
		<br><br>
		<input name="signupPassword" placeholder="Salasõna" type="password"><span style="color:red"><?php echo " " .$signupPasswordError; ?></span>
		<br><br>
